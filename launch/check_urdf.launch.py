...
def generate_launch_description():
    ...
    pkg_urdf_path = FindPackageShare('triton_robot')
    default_rviz_config_path = PathJoinSubstitution([pkg_urdf_path, 'rviz', 'triton_robot.rviz'])
    ...
    model_arg = DeclareLaunchArgument(
        'model', default_value='triton_robot.urdf',
